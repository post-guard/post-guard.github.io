...
const builder:any = {
    ...
    padding: "0",
    border: "0",
    position: {type: "fixed", top: '0', bottom: '0', left: '0', right: '0' },
    width: "100%",
    height: "100%",
    z_index: "-1",
    color: "#E4EFF0",
...
function build() {
    ...
    const mouseInfo = function (e: any) {
        const screen = screenInfo(e), mousex = e ? Math.max(0, e.pageX || e.clientX || 0) : 0,
    ...
    class Factory {
        ...
        init() {
            try {
                ...
                this._canvas.style["position"] = builder.position.type;
                ...
                if(document.getElementById(builder.container)!=null) {

                    let body_ = document.getElementById(builder.container);
        ...
        addRibbon() {
            ...
            let ribbon: any = [], point1 = new Point(startx, starty), point2 = new Point(startx, starty), point3: any = null,
